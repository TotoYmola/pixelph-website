...
COMMANDBOOK_CATEGORIES = [
    ("general", "General", "Chat, voice, and everyday utility commands available to every player.", [
        ...
        ("/jammer", "Open the radio jammer setup menu."),
        ("/rechargeradio", "Recharge your radio's battery."),
        ("/remradiodata", "Remove your saved radio data."),
        ...
        ("/cycleproximity", "Cycle through voice proximity distance modes."),
        ("/removemask", "Remove your equipped medical mask."),
        ("/removevest", "Remove your currently worn body armor/vest."),
        ("/removeprops", "Remove props currently stuck or attached to your character."),
        ("/cancelprogress", "Cancel your active progress bar."),
        ("/ox_lib", "Open your settings menu for notification sound and position."),
        ("/divingsuithud", "Reposition the diving suit's oxygen HUD."),
        ("/removegasmask", "Remove your equipped gas mask."),
        ("/removenightvision", "Remove your equipped night vision goggles."),
        ("/togglenightvision", "Toggle night vision mode while wearing NVGs."),
        ("/togglethermalvision", "Toggle thermal vision mode while wearing NVGs."),
        ("/group", "Open your group/party menu (shared jobs, heists, dispatch)."),
    ]),
    ("character", "Character", "Check your own character, job, and standing.", [
        ...
        ("/xpdisplay", "Open the XP/skill progress display menu."),
        ("/health", "Open your personal health record (illnesses/vitals)."),
        ("/gymstats", "View your own gym training stats."),
    ]),
    ("roleplay", "Roleplay", "Tools for playing your character &mdash; actions, emotes, and expression.", [
        ...
        ("/animations", "Open the animation and emote menu."),
        ("/scene [text]", "Place a decorative roleplay text/prop scene at your location."),
        ("/hidescenes", "Toggle visibility of placed scenes for yourself."),
    ]),
    ("vehicle", "Vehicle", "Commands for driving, trunks, and vehicle ownership.", [
        ...
        ("/hotwire", "Start hotwiring a vehicle you don't have keys for."),
        ("/myfinance", "View/manage your financed vehicles."),
        ("/directsale", "Open the direct sale tablet (inside a dealership)."),
        ("/calltow", "Request a tow truck."),
    ]),
    ("jobs", "Jobs", "Commands tied to a specific job.", [
        ("/ctm", "Cancel your current trucking delivery mission."),
    ]),
    ("business", "Business", "Commands tied to running a business.", [
        ("/cmechanic", "Open the mechanic shop creator to set up a new shop. Real estate job only."),
        ("/setmechanicowner", "Set or transfer a mechanic shop's owner. Real estate job only."),
        ("/locksmith", "Open the Locksmith business actions menu. Locksmith business members only."),
    ]),
    ("mechanic", "Mechanic", "Commands for the mechanic job.", [
        ("/towdispatch", "Open the tow-call dispatch queue."),
    ]),
    ("police", "Police", "Commands for on-duty police and sheriff officers.", [
        ...
        ("/panic", "Panic button &mdash; send a high-priority alert with your location to dispatch."),
    ]),
    ("ems", "EMS", "Commands for on-duty EMS and medical staff.", [
        ("/911 [message]", "Send a 911 emergency alert with your location."),
        ("/bed", "Admit the nearest player into a hospital recovery bed."),
        ("/hospital, /patients", "Open the EMS hospital dashboard (bed status &amp; patients)."),
    ]),
    ("other", "Other", "Everything that didn't fit a category above.", [
        ...
        ("/report", "Send a report to online staff."),
        ("/close_ticket", "Close the train-ticket viewer window."),
        ("/trainticket", "Re-show your most recently issued train ticket."),
    ]),
]
...
KEYBINDS_CATEGORIES = [
    ("general", "General", "Defaults that apply everywhere, on foot or off duty.", [
        ...
        ("F2", "Open your player inventory."),
        ("K", "Open a nearby or targeted secondary inventory (stash, trunk, etc.)."),
        ("R", "Reload your currently held weapon."),
        ("TAB", "Show or hide the item hotbar."),
        ("1 – 5", "Use the item in that hotbar slot."),
        ("= (Equals)", "Open the radio menu."),
        (". / ,", "Switch to the next or previous radio channel."),
        ("F11", "Cycle through voice proximity distance modes."),
        ("Left Alt", "Hold to transmit over your tuned radio channel."),
        ("Gamepad D-pad Up", "Alternate push-to-talk bind."),
        ("Left Alt", "Toggle the targeting/interaction mode."),
        ("Z", "Open or close the radial interaction menu."),
        ("X", "Cancel your active progress bar."),
        ("K", "Toggle crouching on foot."),
        ("X", "Raise or lower your hands. Arrest/robbery scenes."),
        ("HOME", "Show nearby players' server IDs. Useful for reports."),
        ("E", "Tackle a nearby fleeing suspect."),
        ("Backspace", "Close the binoculars view."),
        ("X", "Stand up from a \"sit anywhere\" seated position."),
        ("X", "Get out of the hospital recovery bed early."),
        ("X", "Stand up out of the train-seat animation."),
        ("E", "Interact with casino games."),
    ]),
    ("roleplay", "Roleplay", "Emotes and character animation.", [
        ("F3", "Open the animation/emote menu."),
        ("Backspace", "Stop your current animation."),
        ("X", "Open your favourites animation radial wheel. Hold."),
    ]),
    ("vehicle", "Vehicle", "Driving, seating, and vehicle controls.", [
        ("B", "Buckle or unbuckle your seatbelt."),
        ("Y", "Toggle cruise control while driving."),
        ("E / Shift+E", "Push a nearby vehicle. Hold Shift to push harder."),
        ("F9", "Toggle the in-vehicle radio on or off."),
        ("G", "Turn the vehicle engine on or off."),
        ("L", "Lock or unlock your vehicle."),
        ("O", "Shuffle to another seat in a vehicle."),
    ]),
    ("phone", "Phone", "The one keybind for your in-game phone.", [
        ("M", "Open your phone."),
    ]),
    ...
    ("police", "Police", "On-duty police and sheriff controls.", [
        ("F6", "Open the police interaction menu (cuff, search, drag)."),
        ...
        ("\\ (OEM_5)", "Cycle the radar's direction filter."),
        ("E", "Stop carrying a restrained or dragged person."),
        ("G", "Rappel from a helicopter. Requires a rappel kit item."),
        ("G", "Toggle the on-screen radio channel member list. Police/sheriff only."),
        ("L", "Toggle the vehicle siren control HUD. Emergency vehicles only."),
        ("J", "Toggle emergency lights."),
        ("B", "Cycle siren tone or arm the siren."),
        ("` (OEM_3)", "Mute or unmute the siren audio."),
        ("X", "Manual horn / hi-lo burst."),
        ("F9", "Open the dispatch/alerts panel."),
        ("Z", "Accept a dispatch alert."),
        ("O", "Dismiss a dispatch alert."),
        ("G", "View a dispatch alert."),
        ("J", "Expand a dispatch alert."),
    ]),
    ("ems", "EMS", "On-duty EMS and medical controls.", [
        ("F5", "Open the EMS dispatch/alerts menu."),
        ("DELETE", "Open the medic dispatch/reports board."),
        ("F6", "Open the EMS medical assessment view of nearby patients."),
    ]),
    ("other", "Other", "Controls for a specific minigame &mdash; all while seated at a poker table.", [
        ("Enter", "Ready up."),
        ("V", "Peek at your cards."),
        ("Space", "Focus the table view."),
        ("~ (Tilde)", "Toggle the cursor."),
        ("H", "Toggle the legend/help overlay."),
        ("Tab", "Toggle the UI panel."),
        ("F", "Fold."),
        ("C", "Call."),
        ("R", "Raise."),
        ("1 – 5", "Table emotes."),
        ("Y / U / I / O", "Idle animations."),
    ]),
]
